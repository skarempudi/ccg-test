...
import com.example.srikar.magic.viewmodel.list.CreaturesListViewModel;
...
public interface MainComponent {
    ...
    void inject(CreaturesListViewModel viewModel);
    void inject(LandListViewModel viewModel);
